namespace PurePythonInterpreter
{
        ...
        public object Execute(string code)
        {
            try
            {
                ...
                foreach (var statement in ast)
                {
                    ...
                    {
                        throw new PythonException("RuntimeError", $"Internal error: {ex.Message}");
                    }
                }
            ...
            {
                Console.WriteLine($"  File \"<string>\", line ?, in <module>");
            ...
            catch (Exception ex)
            {
                ...
                if (ex.StackTrace != null)
                {
                    var relevantStack = ex.StackTrace.Split('\n')
                        .Where(line => line.Contains("PurePythonInterpreter"))
                        .Take(3);
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("=== Modular Python Interpreter Demo ===");
