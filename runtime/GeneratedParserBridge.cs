...
namespace SharpPy
{
    ...
    public static class GeneratedParserBridge
    {
        ...
        private static List<Statement> ConvertGeneratedAST(object parseResult, string filename)
        {
            ...
            switch (parseResult)
            {
                ...
                case GeneratedStmtSeq stmtSeq:
                    ...
                    {
                        var converted = ConvertStatement(stmt, false);
                        if (converted != null)
                ...
                case GeneratedStmt stmt:
                    // Single statement
                    var convertedStmt = ConvertStatement(stmt, false);
        ...
        /// </summary>
        private static Statement? ConvertStatement(GeneratedStmt stmt, bool insideLoop = false)
        {
#if DEBUG_LOG
