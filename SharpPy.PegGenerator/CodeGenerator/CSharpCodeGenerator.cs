...
namespace SharpPy.PegGenerator.CodeGenerator
{
    ...
    public partial class CSharpCodeGenerator
    {
        ...
        private void GenerateHelperMethods()
        {
            ...
            WriteLine("{");
            Indent();
            WriteLine("while (CurrentToken?.Type == PyToken.Type.NL)");
            WriteLine("{");
        ...
        private void GeneratePegStmtMethod(string returnType)
        {
            ...
            WriteLine("if (nameToken != null && nameToken.Type == PyToken.Type.NAME)");
            WriteLine("{");
            Indent();
            WriteLine("Advance(); // consume name");
            WriteLine("if (CurrentToken?.Type == PyToken.Type.EQUAL)");
            WriteLine("{");
            Indent();
            WriteLine("Advance(); // consume '='");
            WriteLine("// For now, expect a NUMBER token for the value");
            WriteLine("var valueToken = CurrentToken;");
            WriteLine("if (valueToken?.Type == PyToken.Type.NUMBER)");
            WriteLine("{");
            Indent();
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NUMBER)");
            WriteLine("{");
            Indent();
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME)");
            WriteLine("{");
            Indent();
            ...
            WriteLine("while (CurrentToken?.Type == PyToken.Type.COMMA)");
            WriteLine("{");
            Indent();
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"import\")");
            WriteLine("{");
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"from\")");
            WriteLine("{");
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"raise\")");
            WriteLine("{");
        ...
        private void GenerateAugAssignMethod(string returnType)
        {
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.OP)");
            WriteLine("{");
            Indent();
        ...
        private void GeneratePrimaryParser()
        {
            ...
            WriteLine("if (CurrentToken == null) return null;");
            WriteLine("if (CurrentToken.Type == PyToken.Type.DEDENT) return null;");
            WriteLine("if (CurrentToken.Type == PyToken.Type.ENDMARKER) return null;");
            WriteLine();
        ...
        private void GenerateComparisonMethod()
        {
            ...
            Dedent();
            WriteLine("}");
            WriteLine("else if (CurrentToken.Type == PyToken.Type.NAME)");
            WriteLine("{");
            Indent();
            ...
            WriteLine("if (nextPos < _tokens.Count && _tokens[nextPos].Type == PyToken.Type.NAME)");
            WriteLine("{");
            Indent();
            ...
            Indent();
            WriteLine("var nextPos = _position + 1;");
            WriteLine("if (nextPos < _tokens.Count && _tokens[nextPos].Type == PyToken.Type.NAME && _tokens[nextPos].Value == \"not\")");
            WriteLine("{");
            Indent();
            WriteLine("op = \"IsNot\";");
        ...
        private void GenerateAssignmentExpressionMethod()
        {
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.OP && CurrentToken.Value == \"(\")");
            WriteLine("{");
            Indent();
        ...
        private void GenerateDisjunctionMethod()
        {
            ...
            WriteLine("while (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"or\")");
            WriteLine("{");
            Indent();
        ...
        private void GenerateConjunctionMethod()
        {
            ...
            WriteLine("while (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"and\")");
            WriteLine("{");
            Indent();
        ...
        private void GenerateInversionMethod()
        {
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"not\")");
            WriteLine("{");
            Indent();
            WriteLine("Advance(); // consume 'not'");
        ...
        private void GenerateFStringMethod()
        {
            ...
            WriteLine("if (CurrentToken?.Type != PyToken.Type.FSTRING_START)");
            WriteLine("{");
            Indent();
            WriteLine("return null;");
            Dedent();
            ...
            WriteLine("while (CurrentToken?.Type == PyToken.Type.FSTRING_MIDDLE || ");
            WriteLine("       (CurrentToken?.Type == PyToken.Type.OP && CurrentToken.Value == \"{\"))");
            WriteLine("{");
            Indent();
            ...
            WriteLine("if (CurrentToken?.Type != PyToken.Type.FSTRING_END)");
            WriteLine("{");
            Indent();
        ...
        private void GenerateFStringMiddleMethod()
        {
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.FSTRING_MIDDLE)");
            WriteLine("{");
            Indent();
            WriteLine("var value = CurrentToken.Value;");
        ...
        private void GenerateStringsMethod()
        {
            ...
            WriteLine("{");
            Indent();
            WriteLine("if (CurrentToken?.Type == PyToken.Type.STRING)");
            WriteLine("{");
            Indent();
            WriteLine("var value = CurrentToken.Value;");
            WriteLine("Advance();");
        ...
        private void GenerateAwaitPrimaryGrammarMethod()
        {
            ...
            WriteLine("// Check for AWAIT token");
            WriteLine("if (CurrentToken?.Type == PyToken.Type.AWAIT && CurrentToken?.Value == \"await\")");
            WriteLine("{");
            Indent();
            WriteLine("Advance(); // consume 'await'");
            WriteLine("var primary = ParsePrimary();");
        ...
        private void GenerateStatementMethods()
        {
            ...
            WriteLine("while (_position < _tokens.Count && CurrentToken?.Type != PyToken.Type.ENDMARKER)");
            WriteLine("{");
            Indent();
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NEWLINE || CurrentToken?.Type == PyToken.Type.NL || CurrentToken?.Type == PyToken.Type.COMMENT)");
            WriteLine("{");
            WriteLine("    Advance();");
            WriteLine("    continue;");
            WriteLine("}");
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.DEDENT)");
            WriteLine("{");
            ...
            WriteLine("while (CurrentToken?.Type == PyToken.Type.INDENT)");
            WriteLine("{");
        ...
        private void GenerateFunctionDefMethods()
        {
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"def\")");
            WriteLine("{");
            Indent();
            ...
            Dedent();
            WriteLine("}");
            WriteLine("else if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"class\")");
            WriteLine("{");
            Indent();
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.ASYNC)");
            WriteLine("{");
            Indent();
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"class\")");
            WriteLine("{");
            Indent();
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"match\")");
            WriteLine("{");
            Indent();
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"try\")");
            WriteLine("{");
            Indent();
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"with\")");
            WriteLine("{");
            Indent();
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"if\")");
            WriteLine("{");
            Indent();
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"while\")");
            WriteLine("{");
            Indent();
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"for\")");
            WriteLine("{");
            Indent();
            ...
            WriteLine();
            WriteLine("// '('");
            WriteLine("if (ExpectToken(PyToken.Type.OP, \"(\") == null)");
            WriteLine("{");
        ...
        private void GenerateBasicMethods()
        {
            ...
            WriteLine("while (CurrentToken?.Type == PyToken.Type.OP && CurrentToken.Value == \";\")");
            WriteLine("{");
            Indent();
            WriteLine("Advance(); // consume ';'");
            WriteLine();
            WriteLine("// Optional trailing semicolon before NEWLINE");
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NEWLINE)");
            WriteLine("    break;");
            WriteLine();
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"return\")");
            WriteLine("{");
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"pass\")");
            WriteLine("{");
            WriteLine("    Advance();");
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"break\")");
            WriteLine("{");
            WriteLine("    Advance();");
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"continue\")");
            WriteLine("{");
            WriteLine("    Advance();");
            ...
            WriteLine("    }");
            WriteLine("    else if (CurrentToken?.Type == PyToken.Type.OP && CurrentToken.Value == \")\")");
            WriteLine("    {");
            ...
            WriteLine("{");
            WriteLine("    Advance();");
            WriteLine("    if (CurrentToken?.Type == PyToken.Type.OP && (CurrentToken.Value == \",\" || CurrentToken.Value == \")\"))");
            WriteLine("    {");
            ...
            WriteLine("}");
            WriteLine("else if (CurrentToken?.Type == PyToken.Type.OP && (CurrentToken.Value == \")\" || CurrentToken.Value == \"/\"))");
            WriteLine("{");
            ...
            WriteLine("{");
            Indent();
            WriteLine("if (CurrentToken?.Type != PyToken.Type.NAME) return null;");
            WriteLine();
            WriteLine("var name = CurrentToken.Value;");
            WriteLine("Advance();");
            WriteLine();
            ...
            WriteLine("    Advance(); // consume NEWLINE");
            WriteLine();
            WriteLine("    if (CurrentToken?.Type == PyToken.Type.INDENT)");
            WriteLine("    {");
            ...
            WriteLine("    if (CurrentToken?.Type == PyToken.Type.INDENT && CurrentToken?.Value != null)");
            WriteLine("    {");
            ...
            WriteLine("    }");
            WriteLine("    ");
            WriteLine("    if (ExpectToken(PyToken.Type.INDENT) == null)");
            WriteLine("    {");
            ...
            WriteLine("                if (nextToken.Type == PyToken.Type.NL)");
            WriteLine("                {");
            WriteLine("                    nextPos++;");
            WriteLine("                    continue;");
            WriteLine("                }");
            WriteLine("                else if (nextToken.Type == PyToken.Type.INDENT)");
            WriteLine("                {");
            ...
            WriteLine("                    nextToken.Type == PyToken.Type.NAME && ");
            ...
            WriteLine("                         nextToken.Type == PyToken.Type.OP && nextToken.Value == \"@\")");
            WriteLine("                {");
            WriteLine("                    hasMoreClassContent = true;");
            WriteLine("                }");
            WriteLine("            }");
            ...
            WriteLine("        if (CurrentToken?.Type == PyToken.Type.NL)");
            WriteLine("        {");
            ...
            WriteLine("    while (CurrentToken != null && !(CurrentToken.Type == PyToken.Type.OP && CurrentToken.Value == \")\"))");
            WriteLine("    {");
            WriteLine("        if (CurrentToken.Type == PyToken.Type.NAME)");
            WriteLine("        {");
            WriteLine("            var startPos = _position;");
            ...
            WriteLine("while (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken?.Value == \"except\")");
            WriteLine("{");
            ...
            WriteLine("    if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken?.Value != \":\")");
            WriteLine("    {");
            WriteLine("        exceptionType = CurrentToken.Value;");
            WriteLine("        Advance();");
            WriteLine();
            WriteLine("        // Parse optional 'as' variable");
            WriteLine("        if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken?.Value == \"as\")");
            WriteLine("        {");
            ...
            WriteLine("if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken?.Value == \"finally\")");
            WriteLine("{");
            ...
            WriteLine("while (CurrentToken?.Type == PyToken.Type.NAME)");
            WriteLine("{");
            ...
            WriteLine("if (CurrentToken != null && CurrentToken.Type != PyToken.Type.NEWLINE)");
            WriteLine("{");
        ...
        private void GenerateLambdaParser()
        {
            ...
            WriteLine("if (CurrentToken?.Type != PyToken.Type.NAME || CurrentToken?.Value != \"lambda\")");
            WriteLine("{");
            ...
            WriteLine("while (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken?.Value != \":\")");
            WriteLine("{");
        ...
        private void GenerateDictSetOrCompParser()
        {
            ...
            WriteLine("    }");
            WriteLine("}");
            WriteLine("else if (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken?.Value == \"for\")");
            WriteLine("{");
        ...
        private void GenerateForIfClausesParser()
        {
            ...
            WriteLine("    if (CurrentToken?.Type != PyToken.Type.NAME || CurrentToken?.Value != \"in\")");
            WriteLine("        return null;");
            WriteLine("    Advance(); // consume 'in'");
            WriteLine();
            ...
            WriteLine("    while (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken?.Value == \"if\")");
            WriteLine("    {");
            ...
            WriteLine("} while (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken?.Value == \"for\");");
            WriteLine();
        ...
        private void GenerateDecoratorParsers()
        {
            ...
            WriteLine();
            WriteLine("// NEWLINE");
            WriteLine("if (ExpectToken(PyToken.Type.NEWLINE) == null)");
            WriteLine("{");
            ...
            WriteLine("var cases = new List<object>();");
            WriteLine("while (CurrentToken?.Type == PyToken.Type.NAME && CurrentToken.Value == \"case\")");
            WriteLine("{");
            ...
            WriteLine("while (CurrentToken?.Type == PyToken.Type.DEDENT)");
            WriteLine("{");
            ...
            WriteLine("    Advance(); // consume NAME");
            WriteLine("}");
            WriteLine("else if (CurrentToken?.Type == PyToken.Type.NUMBER)");
            WriteLine("{");
            ...
            WriteLine("    Advance(); // consume NUMBER");
            WriteLine("}");
            WriteLine("else if (CurrentToken?.Type == PyToken.Type.STRING)");
            WriteLine("{");
