...
/// <summary>
/// Python.asdl 파일 파서
/// CPython 3.12 ASDL 형식 파싱
/// </summary>
public class AsdlReader
{
    private string[] _lines = Array.Empty<string>();
    private int _lineIndex = 0;

    public AsdlModule ReadAsdl(string filePath)
    {
        Console.WriteLine($"Reading ASDL from: {filePath}");
        var asdlContent = File.ReadAllText(filePath);
        ...
        Console.WriteLine($"Parsed {module.Types.Count} ASDL types");
        return module;
    }
    ...
    private AsdlField? ParseField(string fieldStr)
    {
        ...
        field.IsOptional = (cardinality == "?");
        field.IsSequence = (cardinality == "*");

        return field;
    }

    private List<AsdlField>? ParseAttributes(string line)
    {
